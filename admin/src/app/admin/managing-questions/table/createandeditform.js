              ...
              <form onSubmit={formconfig.cusfun=="handleSavequestions"?handleSavequestions:handleUpdatequestions}>
                 <div className='grid grid-cols-12 gap-4'>
                    ...
                    <div className='col-span-full lg:col-span-6'>
                      ...
                      <input type="number" id="input-label" name='Level' value={formdata['Level'] || ''} onChange={Changehandler} className="py-3 px-4 block w-full border border-gray-200 rounded-md text-sm focus:border-blue-500 focus:ring-blue-500" />
                    </div>
                    <div className='col-span-full'>
