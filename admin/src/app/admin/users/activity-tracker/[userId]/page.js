...
const tableState = dynamic(() => import('../../../../../hooks/tableState'));
const formState = dynamic(() => import('../../../../../hooks/formState'));
import AuthGuard from "@/app/AuthGuard";
const Activitytracker=()=>{
  const user = AuthGuard();
   const {userId}=useParams();
   const {tablebodydata,setTablebodydata,loading,setLoading,first,setFirst,rows,setRows,totalRecords,setTotalRecords,globalFilter,setGlobalFilter}=tableState();
   //forms
   const {formDialog,setformDialog,viewdata, setViewdata} = formState();
